      ...
      <div class="bg-white rounded shadow-7 w-400 mw-100 p-6">
        ...
        <form>
          ...
          <div class="form-group flexbox py-3">
            ...
            <a class="text-muted small-2" href="recover.php">Forgot password?</a>
          </div>

          <div class="form-group">
            <a class="btn btn-block btn-primary" href="profile.php" type="submit">Login</a>
          </div>
        </form>
        ...
        <p class="text-center text-muted small-2">New here? <a href="register.php">Register here</a> OR <a href="index.php">return to Home.</a></p>
      </div>
